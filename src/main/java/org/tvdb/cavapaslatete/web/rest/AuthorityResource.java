...
import org.tvdb.cavapaslatete.web.rest.errors.BadRequestAlertException;
import tech.jhipster.web.util.HeaderUtil;
import tech.jhipster.web.util.ResponseUtil;

/**
 * REST controller for managing {@link org.tvdb.cavapaslatete.domain.Authority}.
 */
@RestController
...
public class AuthorityResource {
    ...
    @Value("${jhipster.clientApp.name:cVPLT}")
